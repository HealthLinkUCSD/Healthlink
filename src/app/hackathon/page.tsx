  ...
  return <main className="min-h-screen bg-gradient-to-b from-[#071225] via-[#0a1b35] to-[#102647] text-white">
    <header className="relative bg-cover bg-center px-6 pb-16 pt-32" style={{ backgroundImage: "url('/home/hero_bg_large.png')" }}>
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <dl className="mt-10 grid gap-6 border-y border-blue-300/20 py-6 sm:grid-cols-2">
          <div><dt className="text-sm text-blue-300">When</dt><dd className="mt-2 text-2xl font-bold">October 2-4</dd><dd className="mt-1 text-sm text-neutral-300">Daily schedule coming soon</dd></div>
          <div><dt className="text-sm text-blue-300">Where</dt><dd className="mt-2 text-2xl font-bold">The Basement</dd><dd className="mt-1 text-sm text-neutral-300">DIB Building, UC San Diego</dd></div>
        </dl>
    ...
    <div className="mx-auto max-w-5xl space-y-12 px-6 pb-16">
      <section id="tracks" className="scroll-mt-28 space-y-6">
        <div><h2 className="text-3xl font-extrabold">Choose a track</h2><p className="mt-2 text-neutral-300">Tap a card for the challenge and build ideas.</p></div>
        <TrackCards />
      ...
      <section className="grid gap-8 sm:grid-cols-2">
        <div><h2 className="text-2xl font-bold">Funding & prizes</h2><p className="mt-3 text-neutral-300">Total funding and potential prizes coming soon.</p></div>
        <div><h2 className="text-2xl font-bold">Sponsors & partners</h2><Link href="/hackathon/sponsors" className="mt-3 inline-block text-blue-300 underline underline-offset-4 hover:text-blue-100">Meet the track partners</Link></div>
      </section>
      <section className="border-t border-white/10 pt-8"><h2 className="text-2xl font-bold">Last year</h2><p className="mt-3 text-neutral-300">Photos, prizes, and sponsors coming soon.</p></section>
