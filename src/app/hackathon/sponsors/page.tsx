...
export default function SponsorsPage() {
  return <main className="min-h-screen bg-gradient-to-b from-[#071225] via-[#0a1b35] to-[#102647] px-6 py-32 text-white"><div className="mx-auto max-w-6xl space-y-14">
    ...
    <section className="rounded-3xl border border-blue-500/30 bg-white/5 p-8"><h2 className="text-3xl font-bold">Venue</h2><p className="mt-4 text-neutral-300">UC San Diego, The Basement (DIB Building).</p></section>
